...
export default function Design() {
  return (
    <div className={boxStyle} designWork>
      <div className="oneHundred"> <p className="totoSays">Work</p><img width="300px"src={Toto} alt="Work woof woof" /></div>
     
      <ul className="workLi">
      
      <li><a className="workLi" href="https://www.boltstack.com" target="_blank"> I designed and built this marketing Website's front end </a> <img width="300px" src={Boltstack}></img></li>
